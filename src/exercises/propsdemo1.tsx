...
export default function Propsdemo1({ title }: BaseProps) {
  ...
  return (
    <>
      ...
      <Profile name="Rusty Mails" email="rm@email.com" isActive={false} singleLine={showHorizontal} />
      <Profile name="Ella Vator" email="ev@email.com" isActive={true} singleLine={showHorizontal} />    
    </>
  );
}
